...
var Subt = num1 - num2 - num3 - num4 - num5 - num6 - num7 - num8 - num9 - num10;
console.log("Difference  of all numbers is: ", Subt);
console.log("\n");
//Print the result after multiplying all.
var Prod = num1 * num2 * num3 * num4 * num5 * num6 * num7 * num8 * num9 * num10;
...
var allOp = num1 * num2 + num3 - num4 / num5;
